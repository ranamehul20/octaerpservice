...
const HouseMstSchema = new Schema({
    ...
    totalMembers: { type: Number, required: false, trim: true, default:0 },
    totalChildren: { type: Number, required: false, trim: true, default:0 },
    totalAdults: { type: Number, required: false, trim: true, default:0 },
